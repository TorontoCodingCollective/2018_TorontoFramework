...
//	private Direction dir = Direction.FORWARD;
	...
	public DriveDirectionCommand(double direction, double speed, double timeout) {
		this(direction, speed, timeout, true);
	}

	public DriveDirectionCommand(double direction, double speed, double timeout, boolean brakeWhenFinished) {
