...
public class RobotConst {
	...
	public static final boolean RIGHT_ENCODER_ORIENTATION = NOT_INVERTED;
	public static final boolean LEFT_ENCODER_ORIENTATION = INVERTED;
	
	public static final double MAX_LOW_GEAR_SPEED = 365.0;
	public static final double MAX_HIGH_GEAR_SPEED = 830.0;
